...
export const createCommentToEvent: CommentsControllerObject['createCommentToEvent'] =
...
export const removeComment: CommentsControllerObject['removeComment'] = async (
  request,
  response
) => {
  try {
...
export const getCommentListByEventId: CommentsControllerObject['getCommentListByEventId'] =
  async (request, response) => {
    try {
      const {
        user,
...
export const toggleIsImportantComment: CommentsControllerObject['toggleIsLikedComment'] =
  async (request, response) => {
    try {
      const { user, body } = request;
...
export const updateComment: CommentsControllerObject['updateComment'] = async (
  request,
  response
) => {
  try {
